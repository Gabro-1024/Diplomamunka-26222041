        ...
        <div class="sign-in card mx-auto shadow-lg">
          <div class="card-body py-8 px-lg-5">
            <a href="index.php" class="mb-8 hstack justify-content-center">
              <img src="../assets/images/logos/logo-white.svg" alt="logo-dark" class="img-fluid">
            </a>
            ...
            <form class="d-flex flex-column gap-3">
              ...
              <a href="sign-in.php" class="btn btn-dark w-100 justify-content-center py-2 fw-medium my-7 fs-4 lh-lg">
                Sign Up
              </a>
            </form>
            ...
            <p class="mb-0 fw-medium text-center">Already have an account? <a class="text-dark" href="sign-in.php">Sign
                In</a>
            </p>
          </div>
        </div>
