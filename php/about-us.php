...
<div class="page-wrapper overflow-hidden">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-4">
                        <div class="d-flex align-items-center gap-4" data-aos="fade-up" data-aos-delay="100"
                            ...
                            <p class="mb-0 text-white fs-5 text-opacity-70">We provide <span class="text-primary">the best festival tickets</span> for unforgettable experiences and lasting memories</p>
                        </div>
                    </div>
                </div>
                <div class="d-flex align-items-end gap-3" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                    <h1 class="mb-0 fs-16 text-white lh-1">About us</h1>
                    <a href="festivals.php" class="p-1 ps-7 bg-primary rounded-pill">
        ...
        <div class="container">
            <div class="d-flex flex-column gap-5 gap-xl-11 gap-xxl-12">
                <div class="row gap-4 gap-lg-0">
                    <div class="col-lg-4">
                        <h2 class="fs-13 mb-0" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">Tickets at Gábor.</h2>
                    </div>
                    <div class="col-lg-8">
                ...
                <div class="row gx-xl-5">
                    <div class="col-md-6 col-lg-4 mb-8 mb-lg-0">
                        <div class="d-flex flex-column gap-7" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                            <h2 class="mb-0 fs-13 pb-7 border-bottom"><span class="count" data-target="40">40</span>K+</h2>
                            <div class="d-flex flex-column gap-3">
                                <h4 class="mb-0">Tickets sold</h4>
                                <p class="mb-0">Thousands of happy customers have attended their dream events through our service.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 mb-8 mb-lg-0">
                        <div class="d-flex flex-column gap-7" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                            <h2 class="mb-0 fs-13 pb-7 border-bottom"><span class="count" data-target="25">25</span>+</h2>
                            <div class="d-flex flex-column gap-3">
                                <h4 class="mb-0">Partner festivals</h4>
                                <p class="mb-0">Official partnerships with the most popular festivals in Hungary and neighboring countries.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4 mb-8 mb-lg-0">
                        <div class="d-flex flex-column gap-7" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                            <h2 class="mb-0 fs-13 pb-7 border-bottom"><span class="count" data-target="99">99</span>%</h2>
                            <div class="d-flex flex-column gap-3">
                                <h4 class="mb-0">Customer satisfaction</h4>
                                <p class="mb-0">Rated excellent by our customers for reliability and outstanding service.
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <section class="about-img">
        <img src="../assets/images/about/about-img.jpg" alt="Festival crowd enjoying music" class="w-100 object-fit-cover">
        <div class="marquee w-100 d-flex align-items-center overflow-hidden bg-primary py-4">
            <div class="marquee-content d-flex align-items-center gap-8">
                <div class="hstack gap-4 flex-shrink-0">
                    <h4 class="mb-0">Sziget Festival</h4>
                    <span class="round-10 bg-dark bg-opacity-10 rounded-circle flex-shrink-0"></span>
                </div>
                <div class="hstack gap-4 flex-shrink-0">
                    <h4 class="mb-0">Balaton Sound</h4>
                    <span class="round-10 bg-dark bg-opacity-10 rounded-circle flex-shrink-0"></span>
                </div>
                <div class="hstack gap-4 flex-shrink-0">
                    <h4 class="mb-0">VOLT Festival</h4>
                    <span class="round-10 bg-dark bg-opacity-10 rounded-circle flex-shrink-0"></span>
                </div>
                <div class="hstack gap-4 flex-shrink-0">
                    <h4 class="mb-0">EFOTT</h4>
                    <span class="round-10 bg-dark bg-opacity-10 rounded-circle flex-shrink-0"></span>
                </div>
                <div class="hstack gap-4 flex-shrink-0">
                    <h4 class="mb-0">Electric Castle</h4>
                    <span class="round-10 bg-dark bg-opacity-10 rounded-circle flex-shrink-0"></span>
                </div>
                <div class="hstack gap-4 flex-shrink-0">
                    <h4 class="mb-0">Exit Festival</h4>
                    <span class="round-10 bg-dark bg-opacity-10 rounded-circle flex-shrink-0"></span>
                </div>
                <div class="hstack gap-4 flex-shrink-0">
                    <h4 class="mb-0">Sziget Festival</h4>
                        ...
                        <div class="row">
                            <div class="col-xxl-8">
                                <div class="d-flex flex-column gap-6" data-aos="fade-up" data-aos-delay="100"
                                    ...
                                    <p class="fs-5 mb-0 text-opacity-70">Our passionate team of festival enthusiasts is dedicated to providing you with the best ticket purchasing experience and ensuring you get to the events you love.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-xl-3 mb-7 mb-xl-0">
                        <div class="meet-team d-flex flex-column gap-4" data-aos="fade-up" data-aos-delay="100"
                            ...
                            <div class="meet-team-img position-relative overflow-hidden">
                                <img src="../assets/images/about/ticket-manager.jpg" alt="Festival Ticket Manager" class="img-fluid w-100">
                                <div class="meet-team-overlay p-7 d-flex flex-column justify-content-end">
                                    <ul class="social list-unstyled mb-0 hstack gap-2 justify-content-end">
                                        <li><a href="https://github.com/Gabro-1024"
                                               class="btn bg-white p-2 round-45 rounded-circle hstack justify-content-center" target="_blank"><img
                                                        src="../assets/images/svgs/icon-github.svg" alt="github"></a></li>
                                        <li><a href="https://www.linkedin.com/in/gábor-farkas-4b780a2a7/"
                                               class="btn bg-white p-2 round-45 rounded-circle hstack justify-content-center" target="_blank"><img
                    ...
                    <div class="col-md-6 col-xl-3 mb-7 mb-xl-0">
                        <div class="meet-team d-flex flex-column gap-4" data-aos="fade-up" data-aos-delay="200"
                             data-aos-duration="1000">
                            <div class="meet-team-img position-relative overflow-hidden">
                                <img src="../assets/images/about/customer-support.jpg" alt="Customer Support Manager" class="img-fluid w-100">
                                <div class="meet-team-overlay p-7 d-flex flex-column justify-content-end">
                                    <ul class="social list-unstyled mb-0 hstack gap-2 justify-content-end">
                                        <li><a href="#!"
                            ...
                            <div class="meet-team-details">
                                <h4 class="mb-0">Laura Kozma</h4>
                                <p class="mb-0">Customer Support Manager</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3 mb-7 mb-xl-0">
                        <div class="meet-team d-flex flex-column gap-4" data-aos="fade-up" data-aos-delay="300"
                             data-aos-duration="1000">
                            <div class="meet-team-img position-relative overflow-hidden">
                                <img src="../assets/images/about/partner-relations.jpg" alt="Partner Relations Manager" class="img-fluid w-100">
                                <div class="meet-team-overlay p-7 d-flex flex-column justify-content-end">
                                    <ul class="social list-unstyled mb-0 hstack gap-2 justify-content-end">
                                        <li><a href="#!"
                                               class="btn bg-white p-2 round-45 rounded-circle hstack justify-content-center"><img
                            ...
                            <div class="meet-team-details">
                                <h4 class="mb-0">Ágoston Hajnóczy</h4>
                                <p class="mb-0">Partner Relations Manager</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xl-3 mb-7 mb-xl-0">
                        <div class="meet-team d-flex flex-column gap-4" data-aos="fade-up" data-aos-delay="400"
                             data-aos-duration="1000">
                            <div class="meet-team-img position-relative overflow-hidden">
                                <img src="../assets/images/about/marketing-manager.jpg" alt="Marketing Manager" class="img-fluid w-100">
                                <div class="meet-team-overlay p-7 d-flex flex-column justify-content-end">
                                    <ul class="social list-unstyled mb-0 hstack gap-2 justify-content-end">
                                        <li><a href="#!"
                                               class="btn bg-white p-2 round-45 rounded-circle hstack justify-content-center"><img
                            ...
                            <div class="meet-team-details">
                                <h4 class="mb-0">Nikoletta Könyves</h4>
