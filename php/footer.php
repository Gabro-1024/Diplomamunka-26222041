...
<footer class="footer bg-dark py-5 py-lg-11 py-xl-12">
        ...
        <div class="row">
            <div class="col-xl-5 mb-8 mb-xl-0">
                <div class="d-flex flex-column gap-8 pe-xl-5">
                    ...
                    <div class="d-flex flex-column gap-2">
                        <a href="mailto:info@tickets.at.gabor.com" class="link-hover hstack gap-3 text-white fs-5">
            ...
            <div class="col-md-4 col-xl-2 mb-8 mb-xl-0">
                <ul class="footer-menu list-unstyled mb-0 d-flex flex-column gap-2">
                    ...
                    <li><a class="link-hover fs-5 text-white" href="about-us.php">About us</a></li>
                    <li><a class="link-hover fs-5 text-white" href="festivals.php">Festivals</a></li>
                    <li><a class="link-hover fs-5 text-white" href="locations.php">Venues</a></li>
                    <li><a class="link-hover fs-5 text-white" href="FAQ.php">FAQ</a></li>
                    <li><a class="link-hover fs-5 text-white" href="contact.php">Contact</a></li>
                </ul>
            </div>
            <div class="col-md-4 col-xl-2 mb-8 mb-xl-0">
                <ul class="footer-menu list-unstyled mb-0 d-flex flex-column gap-2">
                    <li><a class="link-hover fs-5 text-white" href="https://www.facebook.com/gabor.farkas.3591267/" target="_blank">Facebook</a></li>
                    <li><a class="link-hover fs-5 text-white" href="https://www.instagram.com/gaaborrrrr_03/" target="_blank">Instagram</a></li>
                    <li><a class="link-hover fs-5 text-white" href="https://www.tiktok.com/@gabore003" target="_blank">TikTok</a></li>
                </ul>
            </div>
    ...
    <p class="mb-0 text-white text-opacity-70 text-md-center mt-10">If you're down here, you should now <a class="text-white" href="sign-up.php">sign up</a></p>
</footer>