                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="avatar me-3">
                                                            <span class="avatar-initial rounded-circle bg-primary text-white">
                                                                <?php
                                                                $firstInitial = mb_substr($user['first_name'] ?? '', 0, 1, 'UTF-8');
                                                                $lastInitial = mb_substr($user['last_name'] ?? '', 0, 1, 'UTF-8');
                                                                echo mb_strtoupper($firstInitial . $lastInitial, 'UTF-8');
                                                                ?>
                                                            </span>
                                                </div>
                                                <div>
                                            ...
                                            <div class="btn-group btn-group-sm" role="group">
                                                ...
                                                <?php if ($user['is_blocked']): ?>
                                                    <form method="post" class="d-inline">
                                                        <input type="hidden" name="toggle_block_user"
                                                               value="<?php echo $user['id']; ?>">
                                                        <button type="submit" class="btn btn-sm" title="Unblock User"
                                                                style="background-color: #f8f9fa !important; color: #198754;">
                                                ...
                                                <?php else: ?>
                                                    <form method="post" class="d-inline">
                                                        <input type="hidden" name="toggle_block_user"
                                                               value="<?php echo $user['id']; ?>">
                                                        <button type="submit" class="btn btn-sm" title="Block User"
                                                                onclick="return confirm('Are you sure you want to block this user? They will be logged out and unable to log in again until unblocked.');"
                                                                style="background-color: #f8f9fa !important; color: #dc3545;">
        ...
        <div class="modal-content">
            <form method="post" id="roleForm">
                ...
                <div class="modal-body">
                    <p>Change role for <strong id="userNameDisplay"></strong> from <span id="currentRole"
                                                                                         class="badge"></span> to:</p>
                    <div class="d-flex flex-wrap gap-2">
                        <button type="button" class="btn btn-outline-primary flex-fill role-option mb-2"
                                data-role="raver">
                            <i class='bx bx-user'></i> Raver
                        </button>
                        <button type="button" class="btn btn-outline-success flex-fill role-option mb-2"
                                data-role="organizer">
                            <i class='bx bx-calendar-event'></i> Organizator
                        </button>
                        <button type="button" class="btn btn-outline-info flex-fill role-option mb-2"
                                data-role="worker">
